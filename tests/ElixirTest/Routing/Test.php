...
class Test extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMatchRoutes()
    {
        ...
        $collection->add('root',
                         new Route('index/{name}',
                                   [Route::MVC => 'default::index::index'],
                                   ['name' => '[a-z]+']));
        
        $collection->add('register',
                         new Route('register',
                                   [Route::MVC => 'default::register::login'],
                                   [Route::SECURE => false,
                                         Route::METHOD => 'GET',
    ...
    public function testLoadRoutes()
    {
        ...
        $routing->setRequest($request);
        $routing->load([__DIR__ . '/../../config/routes.xml',
    ...
    public function testGenerateURL()
    {
        ...
        $this->assertEquals('index/user', $routing->generate('root', ['name' => 'user'], QueryGenerator::URL_RELATIVE));
        $this->assertEquals('http://www.test.fr/index/user', $routing->generate('root', ['name' => 'user']));
        ...
        $this->assertEquals('?r=index/user', $routing->generate('root', ['name' => 'user'], QueryGenerator::URL_RELATIVE));
        $this->assertEquals('http://www.test.fr?r=index/user', $routing->generate('root', ['name' => 'user']));
